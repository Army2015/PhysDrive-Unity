...
public class WaterFlowDemo : MonoBehaviour
{
	...
	void OnGUI ()
	{
		...
		// Show version number
		GUI.Window(1, new Rect((Screen.width-260), 5, 250, 80), AppNameWindow, "Water Flow 1.0");
	...
	void WaterSimpleGUIWindow(int id)
	{
		...
		GUI.Label( new Rect(10, 25, 65, 22), "Ambient R" );
		GUI.Label( new Rect(10, 45, 65, 22), "Ambient G" );
		GUI.Label( new Rect(10, 65, 65, 22), "Ambient B" );
		GUI.Label( new Rect(10, 85, 65, 22), "Ambient A" );
		m_WaterSimple_Ambient = new Color (GUI.HorizontalSlider( new Rect(125, 30, 150, 15), RenderSettings.ambientLight.r, 0f, 1f),
		                                   ...
		                                   GUI.HorizontalSlider( new Rect(125, 90, 150, 15), RenderSettings.ambientLight.a, 0f, 1f));
